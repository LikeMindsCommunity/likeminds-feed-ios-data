#
#  Be sure to run `pod spec lint LMFeed.podspec.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "pushpendrasingh"
  # spec.authors            = { "pushpendrasingh" => "pushpendra.singh@likeminds.community" }
  # spec.social_media_url   = "https://twitter.com/pushpendrasingh"
